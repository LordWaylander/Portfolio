<template lang="">
    <div id="gameLife">
      ...
      <GameLifeGameBoard :startApp="startApp" :pauseApp="pauseApp" :restartApp="restartApp" @update-nb-generation="updateNbGeneration"/>
    </div>
  </template>
  <script setup>
  ...
  export default {
    ...
    methods: {
      ...
      updateNbGeneration(value){
        this.nbGeneration = value
      }
    },
  };
  </script>
