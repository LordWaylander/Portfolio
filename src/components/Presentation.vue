<template lang="">
  <div class="cover ">
    <div class="margin-auto center presentation">
      ...
      <div>
        <p>
          Développeur Web curieux et autonome, je suis actuellement à la
        ...
        <p>
          ...
          Ce domaine me passionne, car on ne peut pas rester sur ses acquis, il
          faut sans cesse se mettre à jour et apprendre continuellement.
        </p>
        <p>
          A la suite de ça, j'ai trouvé un emploi à la BML en tant que
